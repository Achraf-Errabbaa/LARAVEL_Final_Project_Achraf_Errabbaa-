    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="mb-8 md:mb-0">
                <h2 class="text-2xl font-bold mb-4">BrainQuest</h2>
                <p class="text-gray-400 mb-4">Empowering minds through online education. Join us in our mission to make quality education accessible to everyone.</p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">Programming</a></li>
            ...
            <div>
                ...
                <p class="text-gray-400 mb-4">Stay updated with our latest courses and educational content.</p>
                <form class="flex flex-col sm:flex-row gap-2">
                    <input type="email" placeholder="Enter your email" class="bg-gray-800 text-white px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
            <p class="text-gray-400 text-sm">&copy; 2024 BrainQuest. All rights reserved.</p>
